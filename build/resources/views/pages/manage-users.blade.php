            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Insert new users</h5>
    ...
    <script type="text/javascript">
        function loadData() {
            $('#datatable').DataTable({
                ...
                "ajax": "{{ url('/manage-users/data') }}",
                "columns": [
                    { "data": "name" },
                    { "data": "email" },
                    { "data": 'balance',  render: $.fn.dataTable.render.number( ',', '.', 3, 'Salt Credit ' )},
                    { "data": "action" }
                ],
                columnDefs: [
                    {
        ...
        $(window).on('load', function () {
            ...
            $('#submit_form').click(function () {
                ...
                if(aksi=="input"){
                    ...
                    $.ajax({
                        url: "{{ url('/manage-users/edit') }}/"+id_data,
                        type: "post",
                        data: new FormData($('#form_input')[0]),
                        async: false,
                        cache: false,
            ...
            $('#datatable tbody').on('click', '#edit', function (e) {
                ...
                $('#balance').val(data.balance).change();
            ...
            $('#datatable tbody').on('click', '#delete', function (e) {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                url: "{{ url('/manage-users/delete/') }}/" + data.id,
                                type: "post",
                                data: {
                                    "_token": "{{ csrf_token() }}",
                                },
